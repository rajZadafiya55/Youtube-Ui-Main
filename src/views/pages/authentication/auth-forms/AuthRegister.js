...
import { registerUserData } from '../../../../redux/actions/userAction';
...
const FirebaseRegister = ({ ...others }) => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(registerUserData(register)); // add register data in useraction method
  ...
  const handleAvatarChange = (e) => {
    setRegister({ ...register, avatar: e.target.files[0] }); // update the avatar field in the register state
  };
        ...
        {({ errors, handleBlur, isSubmitting, touched }) => (
          <form noValidate onSubmit={handleSubmit} {...others}>
            ...
            <FormControl fullWidth sx={{ ...theme.typography.customInput }}>
              <InputLabel htmlFor="outlined-adornment-email-register">Choose avatar</InputLabel>
              <OutlinedInput
                id="outlined-adornment-email-register"
                type="file"
                name="avatar"
            ...
            <FormControl fullWidth sx={{ ...theme.typography.customInput }}>
              <InputLabel htmlFor="outlined-adornment-email-register">Choose coverImage</InputLabel>
              <OutlinedInput
                id="outlined-adornment-email-register"
                type="file"
                name="coverImage"
